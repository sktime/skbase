...
class BaseFixtureGenerator:
    ...
    Test classes inheriting from ``BaseFixtureGenerator``
    and not overriding ``pytest_generate_tests``
    ...
    object_type_filter: str, class variable; None or scitype string
        ...
        filter for ``object_type`` tag for objects that are being retrieved and tested
    ...
    def generator_dict(self):
        ...
        Returns
        -------
        generator_dict : dict, with keys [variable]
            dictionary of methods _generate_[variable] for fixture generation
            where [variable] are all strings such that self has a static method,
