...
def test_import_present_module():
    ...
    result = _safe_import("pytest")
    assert result is not None
    assert _check_soft_dependencies("pytest", severity="error")
...
def test_import_without_pkg_name():
    ...
    result = _safe_import("pytest", pkg_name="pytest")
    assert result is not None
...
def test_import_submodule():
    ...
    result = _safe_import("skbase.utils")
    assert result is not None


def test_import_class():
    """Test importing a class."""
    result = _safe_import("skbase.utils.dependencies._import.CommonMagicMeta")
    assert result is not None
...
def test_soft_dependency_chains():
    ...
    """
    # todo: find an example in the testing dep set
