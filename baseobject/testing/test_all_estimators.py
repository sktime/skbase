...
class BaseFixtureGenerator:
    ...
    fixture_sequence = ["estimator_class", "estimator_instance"]
...
class TestAllEstimators(BaseFixtureGenerator, QuickTester):
    ...
    def test_inheritance(self, estimator_class):
        """Check that estimator inherits from BaseObject."""
        assert issubclass(estimator_class, BaseObject), (
            f"Estimator: {estimator_class} " f"is not a sub-class of " f"BaseObject."
        )
        # Usually estimators inherit only from one BaseObject type, but in some cases
